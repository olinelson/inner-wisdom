...
export default function FAQS() {
    const panels = [
        ...
        },
        {
            ...
            content: [
                'You can book a free 15- telephone consultation online. If we decide to go ahead with an appointment can be usually be made within 72 hours. Existing and returning clients can book sessions online.',
            ].join(' '),
        },
        {
            key: 'in-emergency',
