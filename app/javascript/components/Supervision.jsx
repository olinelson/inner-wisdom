...
export default function Supervision() {
    ...
    return <><TwoColumnContainer text >
        ...
        <ImageDiv gridArea="img" src="https://storage.googleapis.com/inner_wisdom_bucket/bigbonsai.jpg" />
        ...
        <TwoColumnContainer imgLeft text  >
            ...
            <ImageDiv gridArea="img" src="https://storage.googleapis.com/inner_wisdom_bucket/ballpen-blur-close-up-1925536.jpg" />
        </TwoColumnContainer>
    </>
