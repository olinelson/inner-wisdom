...
function Counselling(props) {
    return (
        <Container text >
            ...
            <Header>What is Counselling Psychology?</Header>
            ...
            <p>Specific Counselling approaches include:</p>
            <p>Cognitive Therapy</p>
            <p>Psychodynamic Psychotherapy</p>
            <p>Emotion Focused Therapy</p>
            <p>Creative Therapy: Sandplay, Art, Guided Imagery</p>
            <p>Mindfulness & Yoga Therapy</p>
