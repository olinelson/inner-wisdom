...
function ClientShow () {
  ...
  const { user, csrfToken } = appState
  const [emailError, setEmailError] = useState(appState.emailError)
  ...
  const approveUserHandler = () => {
    setApproving(true)
    const editedUser = { ...user, approved: !user.approved }
