...
#     assert_named_route "/registrations", :user_registration_path
#   end
...
#     assert_recognizes({controller: '/registrations', action: 'cancel'}, {path: 'users/cancel', method: :get})
...
#     assert_recognizes({controller: '/registrations', action: 'new'}, {path: 'admin_area/sign_up', method: :get})
#   end
...
#     assert_recognizes({controller: '/registrations', action: 'new', locale: 'en'}, '/en/accounts/management/register')
#   end

#   test 'map account with custom path name for edit registration' do
#     assert_recognizes({controller: '/registrations', action: 'edit', locale: 'en'}, '/en/accounts/management/edit/profile')
#   end

#   test 'map account with custom path name for cancel registration' do
#     assert_recognizes({controller: '/registrations', action: 'cancel', locale: 'en'}, '/en/accounts/management/giveup')
#   end
...
#     assert_recognizes({controller: '/registrations', action: 'new'}, {path: 'http://192.168.1.100/headquarters/sign_up', method: :get})
#     assert_raise ExpectedRoutingError do
#       assert_recognizes({controller: '/registrations', action: 'new'}, {path: 'http://10.0.0.100/headquarters/sign_up', method: :get})
#     end
#   end

#   test 'map with constraints defined in block' do
#     assert_recognizes({controller: '/registrations', action: 'new'}, {path: 'http://192.168.1.100/homebase/sign_up', method: :get})
#     assert_raise ExpectedRoutingError do
#       assert_recognizes({controller: '/registrations', action: 'new'}, {path: 'http://10.0.0.100//homebase/sign_up', method: :get})
#     end
#   end
...
#   test 'map with format fal registrations' do
#     expected_params = {controller: '/registrations', action: 'new'}
#     expected_params[:format] = false if Devise::Test.rails5_and_up?
...
# #     assert_recognizes({controller: 'pub/registrations', action: 'new'}, {path: '/publisher/accounts/sign_up', method: :get})
